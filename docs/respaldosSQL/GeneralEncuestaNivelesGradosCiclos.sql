...
CREATE TABLE `gruposprofesor` (
  ...
  CONSTRAINT `fk_meGruposProfesor_meMateriaC1` FOREIGN KEY (`idMateria`) REFERENCES `materiae` (`idMateria`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- Dump completed on 2016-02-29 18:30:50
