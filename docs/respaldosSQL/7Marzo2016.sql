...
INSERT INTO `categoria` VALUES (1,'Clima Escolar','Opciones básicas evaluativas','2016-03-07 14:46:40','956f14040b7a0fed998b115b252c9164');
...
INSERT INTO `encuesta` VALUES (1,'Clima Escolar Primaria Primer Grado','CEPPG2017A-V001','Evaluar el clima escolar que genera el docente en sus alumnos','0','2016-03-07 14:54:19','2a201c635535039f6d262548a8b8d6f1');
...
INSERT INTO `grupoe` VALUES (1,3,1,'1101','9cd50138349c77730dfd689e9ff3a4e9');
...
CREATE TABLE `materiae` (
  ...
  KEY `fk_MateriaE_GradoE1_idx` (`idGrado`),
  KEY `fk_MateriaE_CicloE1_idx` (`idCiclo`),
  CONSTRAINT `fk_MateriaE_CicloE1` FOREIGN KEY (`idCiclo`) REFERENCES `cicloe` (`idCiclo`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_MateriaE_GradoE1` FOREIGN KEY (`idGrado`) REFERENCES `gradoe` (`idGrado`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `materiae` VALUES (1,1,3,'Español',2,'7ed543be2d5947d70faf6a029a352a11'),(2,1,3,'Matemáticas',2,'3e1be5edd827bec2f12ad7b7da6c0da8'),(3,1,3,'Idioma',2,'4bac3909450cfe08b4939015fb83a8e5');
...
INSERT INTO `opcion` VALUES (1,1,'Nunca',1,'2016-03-07 14:51:37','acb4acdcbaffdf87cab5f270d5e1452c'),(2,1,'Casi Nunca',2,'2016-03-07 14:51:44','18ddeb0eaafb0cf76cbb8984a9a3b75b'),(3,1,'En ocasiones',3,'2016-03-07 14:51:49','0356d8d298017a5962f655afc3966b36'),(4,1,'Casi siempre',4,'2016-03-07 14:51:59','5d8c5f48754c90eeb20a45f7bf8810d9'),(5,1,'Siempre',5,'2016-03-07 14:55:44','e22254e432d972c71a1c5e72e82590ef');
...
--
-- Table structure for table `profesoresgrupo`
--

DROP TABLE IF EXISTS `profesoresgrupo`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `profesoresgrupo` (
  ...
  KEY `fk_GruposProfesor_Registro1_idx` (`idRegistro`),
  ...
  CONSTRAINT `fk_GruposProfesor_Registro1` FOREIGN KEY (`idRegistro`) REFERENCES `registro` (`idRegistro`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
--
-- Dumping data for table `profesoresgrupo`
--

LOCK TABLES `profesoresgrupo` WRITE;
/*!40000 ALTER TABLE `profesoresgrupo` DISABLE KEYS */;
INSERT INTO `profesoresgrupo` VALUES (1,1,1),(1,2,2),(1,10,3);
/*!40000 ALTER TABLE `profesoresgrupo` ENABLE KEYS */;
UNLOCK TABLES;
