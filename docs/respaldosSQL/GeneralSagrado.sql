...
-- Schema GeneralSagrado
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `GeneralSagrado` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci ;
USE `GeneralSagrado` ;
...
-- -----------------------------------------------------
-- Table `GeneralSagrado`.`meRegistro`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `GeneralSagrado`.`meRegistro` ;

CREATE TABLE IF NOT EXISTS `GeneralSagrado`.`meRegistro` (
...
-- -----------------------------------------------------
-- Table `GeneralSagrado`.`meGrupoC`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `GeneralSagrado`.`meGrupoC` ;

CREATE TABLE IF NOT EXISTS `GeneralSagrado`.`meGrupoC` (
  `idGrupo` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `GeneralSagrado`.`meProfesorC`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `GeneralSagrado`.`meProfesorC` ;

CREATE TABLE IF NOT EXISTS `GeneralSagrado`.`meProfesorC` (
  `idProfesor` INT NOT NULL AUTO_INCREMENT,
  `idRegistro` INT NOT NULL,
  `activo` VARCHAR(1) NOT NULL,
  PRIMARY KEY (`idProfesor`, `idRegistro`),
  INDEX `fk_meProfesorC_Registro1_idx` (`idRegistro` ASC),
  CONSTRAINT `fk_meProfesorC_Registro1`
    FOREIGN KEY (`idRegistro`)
    REFERENCES `GeneralSagrado`.`meRegistro` (`idRegistro`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
COMMENT = '	';
...
-- -----------------------------------------------------
-- Table `GeneralSagrado`.`meMateriaC`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `GeneralSagrado`.`meMateriaC` ;

CREATE TABLE IF NOT EXISTS `GeneralSagrado`.`meMateriaC` (
...
-- -----------------------------------------------------
-- Table `GeneralSagrado`.`meMateriasGrupoC`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `GeneralSagrado`.`meMateriasGrupoC` ;

CREATE TABLE IF NOT EXISTS `GeneralSagrado`.`meMateriasGrupoC` (
  `idGrupo` INT NOT NULL,
  `idMateria` INT NOT NULL,
  PRIMARY KEY (`idGrupo`, `idMateria`),
  INDEX `fk_meMateriasGrupoC_meMateriaC1_idx` (`idMateria` ASC),
  CONSTRAINT `fk_meMateriasGrupoC_meGrupoC1`
    FOREIGN KEY (`idGrupo`)
    REFERENCES `GeneralSagrado`.`meGrupoC` (`idGrupo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_meMateriasGrupoC_meMateriaC1`
    FOREIGN KEY (`idMateria`)
    REFERENCES `GeneralSagrado`.`meMateriaC` (`idMateria`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `GeneralSagrado`.`meGruposProfesorC`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `GeneralSagrado`.`meGruposProfesorC` ;

CREATE TABLE IF NOT EXISTS `GeneralSagrado`.`meGruposProfesorC` (
  `idProfesor` INT NOT NULL,
  `idGrupo` INT NOT NULL,
  `idMateria` INT NOT NULL,
  PRIMARY KEY (`idProfesor`, `idGrupo`, `idMateria`),
  INDEX `fk_meGruposProfesor_meGrupoC1_idx` (`idGrupo` ASC),
  INDEX `fk_meGruposProfesor_meMateriaC1_idx` (`idMateria` ASC),
  CONSTRAINT `fk_meGruposProfesor_meProfesorC1`
    FOREIGN KEY (`idProfesor`)
    REFERENCES `GeneralSagrado`.`meProfesorC` (`idProfesor`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_meGruposProfesor_meGrupoC1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_meGruposProfesor_meMateriaC1`
    FOREIGN KEY (`idMateria`)
    REFERENCES `GeneralSagrado`.`meMateriaC` (`idMateria`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `GeneralSagrado`.`mePeriodo`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `GeneralSagrado`.`mePeriodo` ;

CREATE TABLE IF NOT EXISTS `GeneralSagrado`.`mePeriodo` (
