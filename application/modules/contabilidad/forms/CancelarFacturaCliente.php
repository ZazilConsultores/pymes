...
class Contabilidad_Form_CancelarFacturaCliente extends Zend_Form
{

    public function init()
    {
    	$columnas = array('idFiscales','razonSocial');
		$tablaEmpresa= new Contabilidad_Model_DbTable_Fiscales();
		$rowset = $tablaEmpresa->obtenerColumnas($columnas);
