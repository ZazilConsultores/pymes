...
class Sistema_Form_AltaVendedor extends Zend_Form
{
...

    {
		...
		$eClaveVendedor->setAttrib("class", "form-control");
		...
		$eApPaterno = new Zend_Form_Element_Text("apPaterno");
		$eApPaterno->setLabel("Apellido Paterno: ");
		$eApPaterno->setAttrib("class", "form-control");
		$eApPaterno->setAttrib("required", "true");
		
		$eApMaterno = new Zend_Form_Element_Text("apMaterno");
	...
	//===============================================================
		...
		$eSubmit->setLabel("Crear Vendedor");
