...
class Contabilidad_GuiacontableControllerTest extends Zend_Test_PHPUnit_ControllerTestCase
{
    ...
    public function testAdminmodulosAction()
    {
        $params = array('action' => 'adminmodulos', 'controller' => 'Guiacontable', 'module' => 'contabilidad');
        $urlParams = $this->urlizeOptions($params);
        $url = $this->url($urlParams);
        $this->dispatch($url);
    ...
    public function testEditamodulosAction()
    {
        $params = array('action' => 'editamodulos', 'controller' => 'Guiacontable', 'module' => 'contabilidad');
        $urlParams = $this->urlizeOptions($params);
        $url = $this->url($urlParams);
        $this->dispatch($url);
    ...
    public function testEditamoduloAction()
    {
        $params = array('action' => 'editamodulo', 'controller' => 'Guiacontable', 'module' => 'contabilidad');
        $urlParams = $this->urlizeOptions($params);
        $url = $this->url($urlParams);
        $this->dispatch($url);
    ...
    public function testAdmintiposAction()
    {
        $params = array('action' => 'admintipos', 'controller' => 'Guiacontable', 'module' => 'contabilidad');
        $urlParams = $this->urlizeOptions($params);
        $url = $this->url($urlParams);
        $this->dispatch($url);
